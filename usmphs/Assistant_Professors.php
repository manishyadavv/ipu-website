...
<?php 
$sql = "SELECT * FROM professors where university_school='University School of Medicine and Para-Medical Health Sciences' AND designation='Assistant Professor' order by name";
...
<br>
<div class="big">
<h1><strong>ASSISTANT PROFESSORS</strong></h1>
