...
<script src="../style/scripts/jquery.min(1).js" type="text/javascript"></script>
    ...
    <div id="menu_container"> 
        ...
        <div id="header_logo">
                <a id="ipu_home" href="../"><img src="../style/head_foot_img/220px-usmphsGuru_Gobind_Singh_Indraprastha_University12.png" alt=""></a>			
            </div>
            
            <div id="menuzord" class="menuzord red">
				<a href="javascript:void(0)" class="menuzord-brand">Menuzord</a>
				<ul class="menuzord-menu">
					<li><a href="bos.php">Board of Studies</a>
                    ...
                    <li ><a href="Scheme_Syllabus.php">Scheme/Syllabus</a></li>
