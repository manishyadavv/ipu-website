...
<?php 
$sql = "SELECT * FROM professors where university_school='University School of Medicine and Para-Medical Health Sciences' AND designation='Associate Professor' order by name";
