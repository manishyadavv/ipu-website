...
<?php 
$sql = "SELECT * FROM professors where university_school='University School of Information & Communication Technology' AND designation='Associate Professor' order by name";
