...
<script src="../style/scripts/jquery.min(1).js" type="text/javascript"></script>
    ...
    <div id="menu_container"> 
        ...
        <div id="header_logo">
                <a id="ipu_home" href="../"><img src="../style/head_foot_img/220px-usemGuru_Gobind_Singh_Indraprastha_University12.png" alt=""></a>			
            </div>
            ...
            <div id="menuzord" class="menuzord red">
				...
				<ul class="menuzord-menu">
					...
					<li><a href="../alumni_usem.php">Alumni</a>
					</li>
				</ul>
			</div>
