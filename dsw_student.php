<?php 	
	...
	$sql = 'SELECT * FROM dsw_students ORDER BY s_no desc';
...
<!--   <li class='active'><a href='#'>Director</a></li>-->
   ...
   <li  class='active'><a href='dsw_student.php'>Students' Council</a></li>
...
<br>
<br>      
            <h1 align="center" ><strong>Students' Council</strong></h1>
