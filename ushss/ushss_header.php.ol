...
<script src="../style/scripts/jquery.min(1).js" type="text/javascript"></script>
    ...
    <div id="menu_container"> 
        ...
        <div id="header_logo">
                <a id="ipu_home" href="../"><img src="../style/head_foot_img/220px-ushssGuru_Gobind_Singh_Indraprastha_University12.png" alt=""></a>			
            </div>
            
            <div id="menuzord" class="menuzord red">
				<a href="javascript:void(0)" class="menuzord-brand">Menuzord</a>
				<ul class="menuzord-menu">
					<li><a href="Dean.php">Dean</a>
					...
					<li><a href="javascript:void(0)">Faculty</a>
						<div class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										<li><a class="hvr-underline-from-center" href="Professor.php">Professors</a></li>
							...
							<div class="megamenu-row">
								<div class="col12">
									<ul>
                                        ...
                                        <li><a class="hvr-underline-from-center" href="Notice_Circular.php">Notices/Circulars</a></li>
							...
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										...
										<li><a class="hvr-underline-from-center" href="../exam_results.php">Examination Results</a></li>
									</ul>
								</div>
							</div>
						</div>
