    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          ...
          <div class="container capnone">
            <div class="carousel-caption">
              <h1>Hon'ble Vice President at Convocation Day</h1>
        ...
        <div class="item">
          ...
          <div class="container capnone">
            <div class="carousel-caption">
              <h1>Hon'ble Chief Minister Delivering Speech at Convocation Day</h1>
                ...
                <div class="front_right_block_spotlight">
                    ...
                    <marquee height="100%" direction="up"scrollamount="2" onmouseover="this.stop();" onmouseout="this.start();">
                            ...
                            <div class="eventList" id="&lt;!--dDocTitle--&gt;">
                                ...
                                <div id="link" style="padding: 0px 0 5px 13px;font-size: 14px;color: #0955A0;">
                                            ...
                                            <a style="font-size: 14px;color: #0955A0;" href="http://ipu.ac.in/cet2015adm/phd2015/ratphdmain.htm">Ph.D Scholar Selection</a>
                                </div>
                                <div id="subTitle" style="border-bottom:0px solid #a8a8a8;padding: 0px 13px 13px 13px;font-size:12px;line-height:14px;">
                                    Notice / Interview for the selection of Ph.D. Scholars under various discipline / Schools
                                </div>
                    ...
                    <div class="eventList" id="&lt;!--dDocTitle--&gt;">
                                ...
                                <div id="link" style="padding: 0px 0 5px 13px;font-size: 14px;color: #0955A0;">
                                            ...
                                            <a style="font-size: 14px;color: #0955A0;" href="http://ipu.ac.in/academics/acadnotice/bus310715.pdf">Student Concession Bus Pass</a>
                                </div>
                                <div id="subTitle" style="border-bottom:0px solid #a8a8a8;padding: 0px 13px 13px 13px;font-size:12px;line-height:14px;">
                                    Concession for Students for buses
                                </div>
                        ...
                        <div class="eventList" id="&lt;!--dDocTitle--&gt;">
                                ...
                                <div id="link" style="padding: 0px 0 5px 13px;font-size: 14px;color: #0955A0;">
                                            ...
                                            <a style="font-size: 14px;color: #0955A0;" href="#">Moot Court Competition</a>
                                </div>
                                <div id="subTitle" style="border-bottom:0px solid #a8a8a8;padding: 0px 13px 13px 13px;font-size:12px;line-height:14px;">
                                    4th Indraprastha National Moot Court Competition - Moot Problem and Rules
                                </div>
...
xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");  
  ...
  //window.onload=update_nov ;
    ...
    <a target="" class="_self"  onclick="" href="all_programmes.php">View Our Programmes</a>
    </div>
   ...
   <div style="width:70%;float:left;display:inline;">
    ...
    <a style="color: white;" href="career_plcmnt.php">ALL NEWS » </a>
                    ...
                    <!--FEATURED--> 
                            <div class="eventList" id="&lt;!--dDocTitle--&gt;">
                                ...
                                <div id="link" style="padding: 0px 0 5px 13px;font-size: 14px;color: #0955A0;">
                                            ...
                                            <a style="font-size: 14px;color: #0955A0;" href="http://ipu.ac.in/sports/ntspcm290715.pdf">Volleyball Tournament</a>
                                </div>
                                <div id="subTitle" style="border-bottom:0px solid #a8a8a8;padding: 0px 13px 13px 13px;font-size:12px;line-height:14px;">
                                    Volleyball (Men) North Zone tournament , National University Games 2015-16
                                </div>
                            ...
                            <div class="eventList" id="&lt;!--dDocTitle--&gt;">
                                ...
                                <div id="link" style="padding: 0px 0 5px 13px;font-size: 14px;color: #0955A0;">
                                            ...
                                            <a style="font-size: 14px;color: #0955A0;" href="http://ipu.ac.in/uslaw/lawnotices/moot3007198.pdf">Moot Court Competition</a>
                                </div>
                                <div id="subTitle" style="border-bottom:0px solid #a8a8a8;padding: 0px 13px 13px 13px;font-size:12px;line-height:14px;">
                                    4th Indraprastha National Moot Court Competition - Moot Problem and Rules
                                </div>
                            ...
                            <div class="eventList" id="&lt;!--dDocTitle--&gt;">
                                ...
                                <div id="link" style="padding: 0px 0 5px 13px;font-size: 14px;color: #0955A0;">
                                            ...
                                            <a style="font-size: 14px;color: #0955A0;" href="http://ipu.ac.in/genadmin/escholarship230715.pdf">E-Scholarship Portal</a>
                                </div>
                                <div id="subTitle" style="border-bottom:0px solid #a8a8a8;padding: 0px 13px 13px 13px;font-size:12px;line-height:14px;">
            ...
            <div class="nobackground" style="margin-bottom:40px;background:none;">
                    <div id="allnews">
                                <a href="notices.php" style="color:white;">ALL EVENTS »</a> 
                        </div> 
...
<li><a class="homeMenu" href="http://ipu.ac.in/usict/icctict/icctict.html" onclick="">ICCTICT 2016</a></li>
                   
                    
                    <li ><a class="homeMenu" href="alumni_usict.php" >Alumni</a></li><a>
<li><a class="homeMenu" href="hostels.php" onclick="">Hostel Facilities</a></li>
                    <li style="border-bottom:0px;"><a class="homeMenu" href="http://www.ipuadmissions.nic.in/Documents/FAQ.pdf">Admission FAQ's</a></li> </a></ul><a>
                    
                </a></div><!-- End right sidebar block --><a>
    </a><div id="allnews"><a style="color:white" href="http://ipuadmissions.nic.in/">APPLY ONLINE &raquo;</a>
    </div>	
