...
jQuery(document).ready(function(b){var c=100,e=400,a=400, d=b(".cd-top"); d.addClass("notvisible");b(window).scroll(function(){  (b(this).scrollTop()>c)?d.removeClass("notvisible")&&d.addClass("cd-is-visible"):d.removeClass("notvisible")&&d.removeClass("cd-is-visible cd-fade-out");if(b(this).scrollTop()>e){d.addClass("cd-fade-out")}});d.bind("click",function(f){f.preventDefault();b("body,html").animate({scrollTop:0,},a)})});
            ...
            <div id="menuzord" class="menuzord red">
				...
				<ul class="menuzord-menu">
					<li><a href="javascript:void(0)">Discover GGSIPU</a>
						<div class="megamenu" id="discover_ipu" style="border-radius: 15px;">
<!--						<a href="#"><font color="2554C7" size="3px" border="none">Discover GGS Indraprastha University</font></a><br>-->
							...
							<ul class="globaldropdown"></br> 
                                ...
                                <li><a class="hvr-underline-from-center" href="#" onclick=" "><font color="#323232">Pro Vice Chancellor</font></a></li>
                                    ...
                                    <li><a class="hvr-underline-from-center" href="schools.php" onclick=" "><font color="#323232">Deans</font></a></li> 
                                									<li><a class="hvr-underline-from-center" href="#" onclick=""><font color="#323232">Registrar</font></a></li>
                            ...
                            <div class="col3">
                                    ...
                                    <li><a class="hvr-underline-from-center" href="#" onclick=" "><font color="#323232">CoF</font></a></li>

<li><a class="hvr-underline-from-center" href="#" onclick=" "><font color="#323232">CoE</font></a></li>
<li><a class="hvr-underline-from-center" href="directors.php" onclick=" "><font color="#323232">Directors</font></a></li>
								...
								<div class="col3">
									<ul class="globaldropdown"></br> </br> 
										<li><a class="hvr-underline-from-center" href="library.php" onclick=" "><font color="#323232">Library</font></a></li>
										<li><a class="hvr-underline-from-center" href="alumni_usbt.php" onclick=" "><font color="#323232">Alumni</font></a></li>
										<li><a class="hvr-underline-from-center" href="https://www.google.co.in/maps/uv?hl=en&pb=!1s0x390cfd08624613cd:0x75b127f70af28c04!2m5!2m2!1i80!2i80!3m1!2i100!3m1!7e1!4shttps://plus.google.com/100832009601746995344/photos?hl%3Den%26socfid%3Dweb:lu:kp:placepageimage%26socpid%3D1!5sipu+campus+-+Google+Search&sa=X&ei=Ky01Vfb2E-j8ywO3ioHwAg&ved=0CIgBEKIqMA0" onclick=" "><font color="#323232">Photo Gallery</font></a></li>
									</ul>
								</div>
					...
					<li><a href="javascript:void(0)">Academics</a>
						<div id="academics_head" class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
							
								<div class="col6">
									<a><font color="2554C7" size="3px">Schools & Programs</font></a>									
    <ul class="globaldropdown" color="#666362"></br> 
    							<li><a class="hvr-underline-from-center" href="all_programmes.php"><font color="#323232">View all Programs</font></a></li> 
                        ...
                        <li><a class="hvr-underline-from-center" href="centres.php" onclick=" "><font color="#323232">University Centres</font></a></li>       
                                <li><a class="hvr-underline-from-center" href="affiliated_colleges.php" onclick=" "><font color="#323232">Affiliated Colleges</font></a></li>      
    ...
    <ul class="globaldropdown">  </br> 
					...
					<li><a href="javascript:void(0)">Examinations</a>
						<div id="exam_head" class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
    ...
    <li><a class="hvr-underline-from-center" href="exam_results.php" onclick=" "><font color="#323232">Examination Results</font></a></li>
    <li><a class="hvr-underline-from-center" href="exam_regulation_form.php" onclick=" "><font color="#323232">Regulation Forms</font></a></li>  
                    ...
                    <li><a class="hvr-underline-from-center" href="accounts.php" onclick=" "><font color="#323232">Accounts</font></a></li>
                            ...
                            <ul class="globaldropdown"></br>
                                <br>
                        <li><a class="hvr-underline-from-center" href="estate.php"><font color="#323232">Estate</font></a></li>
     <li><a class="hvr-underline-from-center" href="genadmin.php" onclick=" "><font color="#323232">General Administration</font></a></li>
						...
						<div class="megamenu" id="campus_life" style="border-radius: 15px;">
                            ...
                            <ul class="globaldropdown"> </br>
                                ...
                                <li><a class="hvr-underline-from-center" href="stu_zone.php" onclick=" "><font color="#323232">Cultural Activities</font></a></li> 
                                                               ...
                                                               <li><a class="hvr-underline-from-center" href="srijan.php" onclick=" "><font color="#323232">Srijan</font></a></li>
                                <li style="border-bottom:none;"></li> 
					...
					<li><a href="javascript:void(0)">Events &amp; Notices</a>
						<div class="megamenu" id="events_notices" style="border-radius: 15px;">
							<div class="megamenu-row">
								<div class="col6">
                            ...
                            <ul class="globaldropdown"></br>
                               ...
                               <!-- <li><a class="hvr-underline-from-center" href="#" onclick=" "><font color="#323232">All Events</font></a></li> -->
                            ...
                            <ul class="globaldropdown"> </br>
                                ...
                                <!--<li><a class="hvr-underline-from-center" href="#" onclick=" "><font color="#323232">Job Opportunity</font></a></li> -->
