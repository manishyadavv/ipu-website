...
<script src="../style/scripts/jquery.min(1).js" type="text/javascript"></script>
    ...
    <div id="menu_container"> 
        ...
        <div id="header_logo">
                <a id="ipu_home" href="../"><img src="../style/head_foot_img/220px-usetGuru_Gobind_Singh_Indraprastha_University12.png" alt=""></a>			
            </div>
					...
					<li><a href="javascript:void(0)">Administration</a>
						<div class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										<li><a class="hvr-underline-from-center" href="http://ipu.ac.in/uset/usetbos080515.pdf">Board of studies</a></li>
										<li><a class="hvr-underline-from-center" href="SRC.php">School Research Committee</a></li>
										</ul>
								</div>
							</div>
						</div>
                    ...
                    <li><a href="javascript:void(0)">Academics</a>
						<div class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										<li><a class="hvr-underline-from-center" href="http://ipu.ac.in/uset/listinst151214.pdf">List of affiliated Colleges</a></li>
                                        ...
                                        <li><a class="hvr-underline-from-center" href="Personality_Dev.php">Personality Development</a></li>
									    <li><a class="hvr-underline-from-center" href="http://www.ipu.ac.in/uset/mpc151214.pdf">Major Project Competition Booklet</a></li>
                                    </ul>
								</div>
							</div>
						</div>
