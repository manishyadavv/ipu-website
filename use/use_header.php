...
<script src="../style/scripts/jquery.min(1).js" type="text/javascript"></script>
    ...
    <div id="menu_container"> 
        ...
        <div id="header_logo">
                <a id="ipu_home" href="../"><img src="../style/head_foot_img/220px-useGuru_Gobind_Singh_Indraprastha_University12.png" alt=""></a>			
            </div>
            
            <div id="menuzord" class="menuzord red">
				<a href="javascript:void(0)" class="menuzord-brand">Menuzord</a>
				<ul class="menuzord-menu">
					<li><a href="Dean.php">Faculty Incharge</a>
					...
					<li><a href="http://www.ipu.ac.in/use/useplc090315.pdf">Placement</a>
					</li>
				</ul>
			</div>
